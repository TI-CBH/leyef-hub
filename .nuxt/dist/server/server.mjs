...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/dashboard-CB3lLOGT.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-CIagYFRW.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-C9-iY8Ur.js")
};
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BS0gdbns.js"))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BD0LALni.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-MhmLDoL2.js"));
